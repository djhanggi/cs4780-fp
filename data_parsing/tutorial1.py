# Tutorial as provided by the creaters of the MSDS, with modifications
# from Vesha to make this work in Python3
...
msd_subset_path='/Users/vesha/Desktop/cs4780-fp/MillionSongSubset'
msd_subset_data_path=os.path.join(msd_subset_path,'data')
msd_subset_addf_path=os.path.join(msd_subset_path,'AdditionalFiles')
assert os.path.isdir(msd_subset_path),'wrong path' # sanity check
# path to the Million Song Dataset code
# CHANGE IT TO YOUR LOCAL CONFIGURATION
msd_code_path='/Users/vesha/Desktop/cs4780-fp/MSongsDB'
